...
internal static class Position
{
    ...
    /// <param name="obliquity">The obliquity of the ecliptic in radians.</param>
    /// <returns>The right ascension in radians.</returns>
    internal static double GetRightAscension(double longitude, double latitude, double obliquity)
    {
        return Math.Atan2(
    ...
    internal static double GetDeclination(double longitude, double latitude, double obliquity)
    {
        return Math.Asin(
